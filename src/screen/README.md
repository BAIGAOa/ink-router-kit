...
ink-trc provides a tree-based screen navigation system with **tree walking**, **cross-branch jumping**, and **overlay** support, allowing you to manage terminal UI screens like pages.
